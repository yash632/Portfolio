...
const TechIcons = ({ isMobile }) => {
  ...
  const iconFiles = [
    ...
    "/final_icons/26.png",
    "/final_icons/27.png",
    "/final_icons/ai_brain.png",
    "/final_icons/cognitive_field.png",
    "/final_icons/data_nodes.png",
    "/final_icons/digital_cortex.png",
    "/final_icons/intelligence_core.png",
    "/final_icons/mind_mesh.png",
    "/final_icons/neural_core.png",
    "/final_icons/neural_grid.png",
    "/final_icons/neural_links.png",
    "/final_icons/neural_matrix.png",
    "/final_icons/synapse_flow.png",
    "/final_icons/synaptic_network.png",
    "/final_icons/synthetic_brain.png"
  ];
